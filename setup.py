...
DEPENDENCIES = ['toml','requests','galaxis']
...
def get_version():
    main_file = os.path.join(CURDIR, "smreward", "smreward.py")
...
setup(
    ...
    author_email="nobody@noemail.com",
    description="",
    ...
    entry_points={"console_scripts": [
        "smreward=smreward.smreward:main",
        "smxchecker=smreward.smxchecker:main"
        ]},
